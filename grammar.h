...
#define Match(l) treeConstruct(TreeTypeProposition, (Tree *)(l), NULL)

#define And(l, r) treeConstruct(TreeTypeConjunction, l, r)

#define Or(l, r) treeConstruct(TreeTypeDisjunction, l, r)

#define Map(l, r) treeConstruct(TreeTypeImplication, l, r)

#define Parse(s, x) treeConstruct(TreeTypeProposition, (Tree *)(s), (Tree *)(x))
